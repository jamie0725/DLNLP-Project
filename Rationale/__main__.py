...
def main():
    ...
    parser.add_argument('--lr_enc', type=float, default=1e-2, help='learning rate for the encoder')
    parser.add_argument('--lr_gen', type=float, default=1e-2, help='learning rate for the generator')
    ...
    parser.add_argument('--lambda_1', type=float, default=5e-3, help='regularizer of the length of selected words')
    parser.add_argument('--lambda_2', type=float, default=5e-3, help='regularizer of the local coherency of words')

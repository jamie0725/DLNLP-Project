...
def main():
    ...
    parser.add_argument('--lambda_1', type=float, default=2e-3, help='regularizer of the length of selected words')
    parser.add_argument('--lambda_2', type=float, default=4e-3, help='regularizer of the local coherency of words')
